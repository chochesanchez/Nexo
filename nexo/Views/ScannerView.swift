...
struct ScannerView: View {
    ...
    private var topBar: some View {
                ...
                ForEach(AppMode.allCases, id: \.self) { mode in
                    Button {
                        ...
                        Text(mode.rawValue)
                            ...
                            .foregroundStyle(appMode == mode ? Color.nexoForest : Color.white.opacity(0.6))
                            .padding(.horizontal, 12).padding(.vertical, 7)
                            .background(appMode == mode ? Color.white.opacity(0.92) : Color.clear)
        ...
        .padding(.horizontal, Sp.lg).padding(.top, Sp.lg)
    }
    ...
    private var bottomControls: some View {
        VStack(spacing: 20) {
            ...
            Button {
                ...
                ZStack {
                    Circle()
                        .strokeBorder(Color.nexoAmber.opacity(0.3), lineWidth: 1)
                    ...
                    Circle()
                        ...
                        .overlay {
                            if camera.isAnalyzing {
                                ProgressView().tint(Color.nexoForest).scaleEffect(0.8)
                            } else {
                                Circle()
                                    .strokeBorder(Color.nexoForest.opacity(0.2), lineWidth: 2)
